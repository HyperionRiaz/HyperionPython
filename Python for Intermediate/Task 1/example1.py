...
# Now that you have ensured that you install Notepad++, PLEASE ENSURE YOU OPEN THIS FILE IN NOTEPAD++ otherwise you will not be able to read it.
...
# Welcome to the Python programming course for people with a background in programming.
# You may feel that since you already know a language, you can skip through everything.
# Unfortunately this is not the case. Please carefully read this content of all these example files so that you do not miss out on important information about Python.
...
# *** WARNING ***
# We are aware that this task has 4 seperate portions of example code and covers everything from variables to lists and looping in Python.
# This is because this course is an Intermediate Python Course, intended for those who are studying Computer Science and know Java well.
# Should you at any point feel that you need to take it slower, plese contact us immediatly and we will switch you to a slower Python course.
# You will still be able to progress to exciting courses, but will have more explanations and examples to learn the basics of Python.

# There is an Example Programs folder in this Task 1 folder. Look through all the programs here after reading example1 - example4. 
...
#========= A quick refresher on some basic background ===
