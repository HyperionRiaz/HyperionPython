#Welcome to the example file for task '2.5'.
...
# Now, edit the first and last word (ie the first and last element of your list) to capitalise the first letter of the sentence, and add a full stop to the end of the sentence.
...
#   Create a hash called hotMap, where the the KEYS are the name and surname of the person (ie a String), and the VALUE for each key is either the string 'hot' or 'not'
