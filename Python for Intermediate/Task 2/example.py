#Welcome to the example file for your second task.
...
#'Now you should have all the tools you need to do Task 2. 
...
#Now, create a python file called forgetful.py . Imagine your friend was very forgetful and always seemed to enter his email password inc#orrectly. You want to write a python program that takes all his incorrect password entries, stores it in a list, then records 
